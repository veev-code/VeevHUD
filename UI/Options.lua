						...
						args = {
							...
							globalCooldown = {
								...
								args = {
									...
									gcdSpiralAlpha = {
										type = "range",
										name = L["GCD Spiral Opacity"],
										desc = L["How dark the Global Cooldown swipe appears on icons. Independent from Cooldown Spiral Opacity, so you can hide the cooldown spiral while keeping the GCD swipe visible (or vice versa)."],
										min = 0, max = 1.0, step = 0.05,
										isPercent = true,
										arg = "icons.gcdSpiralAlpha",
										order = 2,
										disabled = function()
											return addon.db and addon.db.profile and addon.db.profile.icons and addon.db.profile.icons.showGCDOn == C.ROW_SETTING.NONE
										end,
									},
								},
							},
